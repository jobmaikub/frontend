  ...
  return (
    <div className="min-h-screen font-['Inter'] flex flex-col bg-[#F4F7FF]">
      ...
      <main className="flex-grow flex flex-col">
        {/* Header Skeleton */}
        <div className="w-full bg-white pt-24 pb-12 flex flex-col items-center text-center px-8 shadow-sm">
        ...
        <section className="pb-20 pt-12">
          <div className="mx-auto w-full px-8 max-w-4xl">
              ...
              {/* Form Card Skeleton */}
              <div className="w-full rounded-[32px] border border-gray-100 bg-white p-10 shadow-sm">
