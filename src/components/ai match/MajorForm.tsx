    ...
    <>
      ...
      <div className="w-full rounded-2xl border border-gray-100 bg-white p-6 sm:p-10 shadow-sm">
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            <h2 className="text-[20px] sm:text-[22px] font-semibold text-gray-900">Select Your Major</h2>
            <p className="text-[16px] sm:text-[18px] text-gray-500 mt-1">What is your field of study?</p>
          </div>
