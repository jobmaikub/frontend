    ...
    <div className="min-h-screen bg-background pt-16">
      ...
      <div className="mx-auto -mt-20 max-w-5xl px-8 pb-24">
        <div className="grid gap-6 md:grid-cols-[280px_1fr]">
          ...
          {/* Left Column (Profile Card - Matched with ProfileCard.tsx) */}
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[...Array(3)].map((_, i) => (
                <div key={i} className="rounded-xl border border-border bg-card p-4 h-[100px] flex items-center gap-4">
            ...
            {/* Skills Mastered Area Skeleton (Updated to match grid layout) */}
